...
- [x] T1 측정 10회 (SR 50%, §9.2)
- [x] T2 FT 데이터 확보(기존 30ep 재사용) + 학습 완료
- [x] T2 측정 10회 (유효 8회, 엄격 SR 0%·평균 진행률 29%, §10.3 — 2건 오염 제외)
- [x] T1 대표 클립 (성공 1 + 실패 1)
- [x] T2 대표 클립: `report/clips/smolvla_ft_t2_partial_trial2.mp4` (ep2, 2/3 최고 진행도, 순수 자력)
...
| 데이터 부족(30ep < 논문 50ep) | T1·T2 둘 다 측정 완료 → **50ep 보강 재학습을 다음 실험으로 결정**(사용자 확정) |
