...
- [x] T1 FT (v1) 데이터 확보(30ep 재사용) + 학습·측정 10회 (SR 50%, §9.2)
- [x] T2 FT (v1) 데이터 확보(30ep 재사용) + 학습·측정 10회 (유효 8회, 엄격 SR 0%·평균 29%, §10.3)
- [x] **T1 v2** 50ep 재수집·학습·측정 10회 (SR 30%, epoch 교란 규명, §11)
- [ ] **T1 v3** epoch 통제 재학습(steps 45k) — 진행 중
- [ ] **T2 v2** 측정 10회 — 학습 완료, 대기
- [x] T1 대표 클립 (성공 1 + 실패 1)
- [x] T2 대표 클립: `report/clips/smolvla_ft_t2_partial_trial2.mp4` (ep2, 2/3 최고 진행도, 순수 자력)
- [ ] 모델 요약 카드 최종본 (v1/v2 + ACT 대비 비교 포함)
- [x] 로그·클립 백업
